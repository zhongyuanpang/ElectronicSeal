...
public class Test {
    private static final String INPUT_PDF = System.getProperty("user.dir") + "/template/cs.pdf";
    private static final String OUTPUT_PDF = System.getProperty("user.dir") + "/template/cs_SEAL.pdf";
